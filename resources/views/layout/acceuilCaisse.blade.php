                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarPages">
                                <ul class="side-nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{url('pages-maintenance.html')}}">Maintenance</a>
                                    </li>
                                    <li>
                                        <a href="{{url('error-404.html')}}">Error 404</a>
                                    </li>
                                    <li>
                                        <a href="{{url('error-404-alt.html')}}">Error 404-alt</a>
                                    </li>
                                    <li>
                                        <a href="{{url('error-500.html')}}">Error 500</a>
                                    </li> --}}
                                </ul>
                            </div>
                        </li>
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div class="card widget-flat text-bg-pink">
                                    <div class="card-body">
                                        ...
                                        <h6 class="text-uppercase mt-0" title="Customers">Nombre De Facture</h6>
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div class="card widget-flat text-bg-purple">
                                    <div class="card-body">
                                        ...
                                        <h6 class="text-uppercase mt-0" title="Customers">Ajouter Une Facture</h6>
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div class="card widget-flat text-bg-info">
                                    <div class="card-body">
                                        ...
                                        <h6 class="text-uppercase mt-0" title="Customers">Voir Liste Des Factures</h6>
