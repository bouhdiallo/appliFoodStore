    ...
    <section id="home" class="page overlay">
        <div class="container">
            <div class="content cover text-center">
                <div class="row">
                    <div class="col-sm-12">
                        <h1 class="mt-0 mb-4 animated hiding" data-animation="fadeInDown" data-delay="300">ESPACE GESTION PRODUIT CLIENT ET FOURNISSEURS</h1>
                        <a class="mt-0 mb-4 btn btn-blue" data-animation="fadeIn" data-delay="900" href="{{ route('formProduct') }}">Ajouter une produit</a>
                        <a class="mt-0 mb-4 btn btn-blue" data-animation="fadeIn" data-delay="900" href="{{ route('formSupplier') }}">Ajouter une un fournisseur</a>
                        <a class="mt-0 mb-4 btn btn-blue" data-animation="fadeIn" data-delay="900" href="{{ route('formCustomer') }}">Ajouter un client</a>


                        {{-- <a class="mt-0 mb-4 btn btn-blue nav-external animated hiding" data-animation="fadeIn" data-delay="900" href="{{url: route('formAccount')}}">Ajouter une facture</a> --}}
                        ...
                        {{-- <a class="mt-0 mb-4 btn btn-blue nav-external animated hiding" data-animation="fadeIn" data-delay="900" href="#services">Voir la liste des factures</a> --}}
                        {{-- <a class="mt-0 mb-4 btn btn-blue nav-external animated hiding" data-animation="fadeIn" data-delay="900" href="#services">Clic ici pour effcetuer pour plus de details</a> --}}
     ...
     <div id="navbar-top">
        <nav class="navbar navbar-expand-md navbar-light bg-white fixed">
            <div class="container">
                <a class="navbar-brand nav-external" href="#home">American Food Store</a>
