            ...
            <div class="content cover text-center">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h1 class="mt-0 mb-4 animated hiding" data-animation="fadeInDown" data-delay="300">ESPACE FACTURATION</h1>
                        <a class="mt-0 mb-4 btn btn-blue" data-animation="fadeIn" data-delay="900" href="{{ route('formAccount') }}">Ajouter une facture</a>
