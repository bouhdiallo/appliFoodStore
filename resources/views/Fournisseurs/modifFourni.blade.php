...
<form action="{{ route('updateSupplierProcess', ['id' => $fournisseur->id]) }}" method="POST">
...
{{-- <form action="{{route ('addSupplier')}}"  method="POST"> --}}
    ...
    <fieldset>
      ...
      <input type="text" name="id" class="form-control" style="display: none;" value=" {{$fournisseur->id}}" id="nom_client" aria-describedby="emailHelp" placeholder="Entrez le Nom">

      <div>
        <label for="nom_fournisseur" class="form-label mt-4"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Nom</font></font></label>
        <input type="nom" name="nom" class="form-control" value=" {{$fournisseur->nom}}" id="nom" aria-describedby="emailHelp" placeholder="Entrez le Nom">
      ...
      <div>
        ...
        <input type="contact" name="contact" class="form-control" value=" {{$fournisseur->contact}}" id="contact" placeholder="contact" autocomplete="off">
      </div>
      ...
      <div>
        ...
        <input type="adress" name="adress" class="form-control" value=" {{$fournisseur->adress}}" id="adress" placeholder="adress" autocomplete="off">
      </div>
